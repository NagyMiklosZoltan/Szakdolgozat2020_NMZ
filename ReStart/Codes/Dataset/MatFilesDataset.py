...
def getAverageIT_RDM(input):
    fMRI_mat = input
    fMRI = h5py.File(fMRI_mat, 'r')
    print(fMRI.keys())

    data = fMRI.get('IT_RDMs')
    data = np.array(data)
...
# print(getAverageIT_RDM(r'C:\Users\NagyMiklosZoltan\PycharmProjects\Szakdolgozat2020\algonautsChallenge2019'
#                        r'\Training_Data\92_Image_Set\target_fmri.mat'))
