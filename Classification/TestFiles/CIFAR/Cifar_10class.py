...
#
# np.save('../CIFAR_bottleneck_features_train.npy', bottleneck_features_train)
...
#
# np.save('../CIFAR_bottleneck_features_valid.npy', bottleneck_features_validation)
# end = datetime.datetime.now()
# elapsed = end - start
# print('Time: ', elapsed)
...
train_data = np.load('../CIFAR_bottleneck_features_train.npy')
...
# load the bottleneck features saved earlier
validation_data = np.load('../CIFAR_bottleneck_features_valid.npy')
...
model.save_weights('../Weights.np5')
